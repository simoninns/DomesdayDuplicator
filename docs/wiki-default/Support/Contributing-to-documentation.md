...
This documentation is hosted on [GitHub Pages](https://pages.github.com/) and generated from Markdown files in the [ld-decode-docs repository](https://github.com/happycube/ld-decode-docs). All documentation source files are located in the `wiki-default/` directory.

If you don't have the time or the knowledge to work with github, but you spot an issue and still want to help, please use the github issues located in the [documentation github repository](https://github.com/happycube/ld-decode-docs) - make sure you clearly link the page in question and state what's wrong.

### Contributing via Pull Requests

1. **Fork the repository**: Visit [https://github.com/happycube/ld-decode-docs](https://github.com/happycube/ld-decode-docs) and click the "Fork" button to create your own copy.
...
8. **Create a Pull Request**: Go to the [original repository](https://github.com/happycube/ld-decode-docs) and click "New Pull Request" to submit your changes for review.
...
- Open an issue on the [GitHub repository](https://github.com/happycube/ld-decode-docs/issues)
