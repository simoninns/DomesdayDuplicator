...
| *The device restarted … and is attached as a Duplicator (1209:2347), but this application cannot open it*, on page 6, on Windows | WinUSB has never been bound to `1209:2347` on this machine. Nothing was written; bind it with Zadig and run the wizard again — see [Both boards, connected](#2-both-boards-connected) above |
