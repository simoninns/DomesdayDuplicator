...
![](assets/Digital-Media-Preservation/Piracy_music_CD-780x350.jpg)
...
![](assets/Digital-Media-Preservation/oneframeofcddata.jpg){ width="900" }
...
![](assets/Digital-Media-Preservation/National-Laserdisc.jpg){ width="700" }
...
![](https://github.com/oyvindln/vhs-decode/wiki/assets/images/graphics/Signals-Path-Of-Decode.png){ width="900" }
