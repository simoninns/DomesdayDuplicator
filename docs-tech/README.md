...
Status: **Phases 0–3 complete.** Written 2026-08-12 against commit `bcd53a0`; the work runs
...
| 3 — Nix foundation and easy flakes | Done. `nix flake check` passes; **D18 and D19 closed**; 44 tests where there were none |
| 4 — docs: Jekyll → MkDocs Material | Next |
| 5 — fx3 firmware flake | Not started |
