...
reorganisation there were **no automated tests at all**. There are now 488 across five
...
### 4.2 `ddd-gui/` — 410 tests (404 without hardware)
...
| `tests/gui/widget/test_statistics_panel.cpp` | That the figures reach the right labels: the four integrity states reading differently, a new run clearing the last one's numbers, and a finished run leaving them up | T1 |
